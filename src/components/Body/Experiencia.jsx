                    ...
                    <div className='item'>
                        ...
                        <div className='ctn-txt'>
                            ...
                            <ul className='funciones'>
                                ...
                                <li> Diseño y desarrollo con responsive de la nueva pagina del Banco de la Nación (www.bn.com.pe).</li>
                    ...
                    <div className='item'>
                        ...
                        <div className='ctn-txt'>
                            ...
                            <ul className='funciones'>
                                ...
                                <li>Implementación de diseño responsive utilizando HTML5, CSS3 (Media Queries) y JavaScript para garantizar una experiencia de usuario óptima en dispositivos móviles, tabletas y pantallas de escritorio.</li>
